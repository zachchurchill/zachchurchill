...
\begin{document}
  ...
  \begin{flushleft}
	...
	best practice recommendations, and strategic solution brainstorming alongside solution engineers and data scientists.
    }
    \medskip

    \company{State of Ohio - MHAS}{Columbus OH}{Mar 2022}{Sept 2022}
    
    \position{Software Development Specialist 4 (Data Scientist)}{Mar 2022}{Sept 2022}{Python, SQL, PowerBI}
    \bulletpoint{
